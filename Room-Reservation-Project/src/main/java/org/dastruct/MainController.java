...
public class MainController {
    ...
    private static final String ROOMS_CSV_PATH = "src/main/resources/org/dastruct/rooms.csv";
    ...
    protected void openReserveWindow(Room room) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/dastruct/reserve.fxml"));
            Parent root = loader.load();
            root.getProperties().put("controller", this);
